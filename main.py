# -*- coding: utf-8 -*-
"""convolutional_neural_network(1)(1)_(1)(1)(1).ipynb
...
"""#Section 2 - Using pre-trained models to train and evaluate."""
...
results=pre_trained_model.fit(x = training_set, validation_data = val_set, epochs = 15, callbacks=checkpoint)
